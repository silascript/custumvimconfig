...
call plug#begin()
	...
	" easycomplete 补全框架插件集
	"  与 ultisnips 整合插件集
	source ~/.vim/configs/config_data/plugins/plug_complete/plugins_complete_easycomplete_ultisnips.vim
...
"  框架插件配置
source ~/.vim/configs/config_data/settings/complete/settings_complete_easycomplete.vim
...
"  补全框架插件快捷键配置
" source ~/.vim/configs/config_data/keymaps/
