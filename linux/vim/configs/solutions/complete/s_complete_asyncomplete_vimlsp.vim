...
call plug#begin()
	...
	" asyncomplete 基础插件集
	" source ~/.vim/configs/config_data/plugins/plug_complete/plugins_complete_asyncomplete_basic.vim
	"  与 ultisnips 整合插件集
	" source ~/.vim/configs/config_data/plugins/plug_complete/plugins_complete_asyncomplete_ultisnips.vim
	" asyncomplete ultisnips vim-lsp 整合插件
	source ~/.vim/configs/config_data/plugins/plug_complete/plugins_complete_asyncomplete_lsp_ultisnips.vim
...
source ~/.vim/configs/config_data/settings/complete/settings_complete_asyncomplete_vimlsp.vim
...
source ~/.vim/configs/config_data/keymaps/keymaps_plugins_complete_asyncomplete.vim
