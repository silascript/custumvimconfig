...
call plug#begin()
	...
	# completor 补全框架插件集
	# completor ultisnips 插件整合集
	import "~/.vim/configs/config_data/plugins/plug_complete/plugins_complete_completor_ultisnips_vimsnippets.vim"
...
# completor ultisnips 插件整合配置
import "~/.vim/configs/config_data/settings/complete/settings_complete_completor_basic.vim"
