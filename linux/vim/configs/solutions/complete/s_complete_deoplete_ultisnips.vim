...
call plug#begin()
	...
	" deoplete 补全框架插件集
	" deoplete ultisnips 插件整合集
	source ~/.vim/configs/config_data/plugins/plug_complete/plugins_complete_deoplete_ultisnips.vim
...
" deoplete ultisnips 插件整合配置
source ~/.vim/configs/config_data/settings/complete/settings_complete_deoplete_ultisnips.vim
