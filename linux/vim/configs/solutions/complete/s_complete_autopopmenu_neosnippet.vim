...
# -------------------------------------------------
#	vim-auto-popmenu + neosnippet 补全插件整合方案
# -------------------------------------------------
...
call plug#begin()
	...
	# neosnippet 插件 使用 neosnippet-snippets仓库
...
# import "~/.vim/configs/config_data/keymaps/keymaps_plugins_complete_autopopmenu.vim"
