...
# ----------------------------------------------
#	 deoplete + deoplete-clangx 补全插件整合方案
# ----------------------------------------------
...
call plug#begin()
	...
	# deoplete 补全框架插件集
	# deoplete + deoplete-clangx 插件套件集
	import "~/.vim/configs/config_data/plugins/plug_complete/plugins_complete_deoplete_clang.vim"
...
import "~/.vim/configs/config_data/settings/complete/settings_complete_deoplete_clang.vim"
