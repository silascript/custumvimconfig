...
call plug#begin()
	...
	source ~/.vim/configs/config_data/plugins/plug_complete/plugins_complete_deoplete_snipmate.vim
...
" deoplete snipmate 插件整合配置
source ~/.vim/configs/config_data/settings/complete/settings_complete_deoplete_snipmate.vim
