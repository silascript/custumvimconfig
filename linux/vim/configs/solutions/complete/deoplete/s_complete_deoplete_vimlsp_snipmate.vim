...
# ---------------------------------------------
#	deoplete vim-lsp snipmate 补全插件整合方案
# ---------------------------------------------
...
call plug#begin()
	...
	# deoplete 补全框架插件集
	# deoplete vim-lsp snipmate 整合插件集
	import "~/.vim/configs/config_data/plugins/plug_complete/plugins_complete_deoplete_lsp_snipmate.vim"
...
# deoplete vim-ls snipmate 插件整合配置
import "~/.vim/configs/config_data/settings/complete/settings_complete_deoplete_vimlsp_snipmate.vim"
