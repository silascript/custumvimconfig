" ---------------------------------------------
"	deoplete vim-lsp ultisnips 补全插件整合方案
" ---------------------------------------------
...
call plug#begin()
	...
	" deoplete 补全框架插件集
	" deoplete vim-lsp ultisnips 整合插件集
	source ~/.vim/configs/config_data/plugins/plug_complete/plugins_complete_deoplete_lsp_ultisnips.vim
...
" deoplete vim-ls ultisnips 插件整合配置
source ~/.vim/configs/config_data/settings/complete/settings_complete_deoplete_vimlsp_ultisnips.vim
