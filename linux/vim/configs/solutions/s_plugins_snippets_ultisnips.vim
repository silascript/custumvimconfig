...
" snippets 插件配置
" settings_plugins_snippets 这个配置引入了snipmate ultisnips及neosnip 三个snippet引擎配置
" source ~/.vim/configs/config_data/settings/settings_plugins_snippets.vim
" ultisnips
source ~/.vim/configs/config_data/settings/snippet/settings_plugins_snippets_ultisnips.vim
