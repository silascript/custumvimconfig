...
plugpac#Begin({
  ...
  verbose: 2,
	...
	#  与 ultisnips 整合插件集
	import "~/.vim/configs_new/config_data/plugins/plug_complete/plugins_complete_easycomplete_ultisnips.vim"
...
#  框架插件配置
import "~/.vim/configs_new/config_data/settings/complete/settings_complete_easycomplete.vim"
